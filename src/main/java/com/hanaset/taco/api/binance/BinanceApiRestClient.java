...
public interface BinanceApiRestClient {
     ...
     */
    BinanceOrderBook getOrderBook(String symbol, Integer limit);

    Single<BinanceOrderBook> getOrderBookRx(String symbol, Integer limit);
     ...
     */
    List<Object[]> getCandlestickBars(String symbol, CandlestickInterval interval, Integer limit, Long startTime, Long endTime);

    Single<List<Object[]>> getCandlestickBarsRx(String symbol, CandlestickInterval interval, Integer limit, Long startTime, Long endTime);
     ...
     */
    List<Object[]> getCandlestickBars(String symbol, CandlestickInterval interval);
    ...
    Single<List<TickerPrice>> getAllPricesRx();

    Single<TickerPrice> getPrice(String symbol);
    ...
    Single<NewOrderResponse> newOrderRx(NewOrder order);
    ...
    Single<Order> getOrderStatusRx(OrderStatusRequest orderStatusRequest);
    ...
    Single<Map> cancelOrderRx(CancelOrderRequest cancelOrderRequest);
    ...
    Single<List<Order>> getOpenOrdersRx(OrderRequest orderRequest);
    ...
    Single<List<Trade>> getMyTradesRx(String symbol);
    ...
    Single<DepositHistory> getDepositHistoryRx(String asset);
    ...
    Single<WithdrawHistory> getWithdrawHistoryRx(String asset);
    ...
    Single<Response<Map>> keepAliveUserDataStreamRx(String listenKey);
    ...
    Single<Void> closeUserDataStreamRx(String listenKey);
}