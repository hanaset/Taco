...
import com.hanaset.taco.api.binance.BinanceApiAsyncRestClient;
...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
    ...
    private BinanceApiServiceGenerator binanceApiServiceGenerator;
    ...
    @Override
    public void getOrderBook(String symbol, Integer limit, BinanceApiCallback<BinanceOrderBook> callback) {
