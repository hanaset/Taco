...
@Slf4j
@Component
public class UpbitMercyWebSocketHandler extends BinaryWebSocketHandler {

    private final UpbitPairSearchService upbitPairSearchService;

    public UpbitMercyWebSocketHandler(UpbitPairSearchService upbitPairSearchService) {
        ...
        try {
            ...
            if(jsonObject.get("type").equals("orderbook")) {
                ...
                if (!OrderbookCached.UPBIT_BTC.isEmpty()) {
                    ...
                    upbitPairSearchService.checkProfit(Taco2UpbitConvert.convertPair(upbitOrderBook.getCode()));
                }
            }
